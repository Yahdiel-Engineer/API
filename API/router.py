...
from API.crud import crud, get_product_by_barcode, get_product_category_by_id, get_product_template_by_id, get_stock_quant_by_product_id, mettre_a_jour_prix, tous_les_produits
